...
public static class Input
{
    ...
    private static bool ValidatePathToDirectory(string pathToDirectory)
    {
        return Directory.Exists(pathToDirectory);
    }

    private static bool ValidateNumberOfLines(string inputNumberOfLines)
    {
        bool isInteger = int.TryParse(inputNumberOfLines, out _);
        return isInteger;
    }

    private static bool ValidateChosenColumns(string chosenColumns, string[] origProperties)
    {
    ...
    private static bool ValidateChosenNumberOfFile(int number, Dictionary<int, string> fileDictionary)
    {
        return fileDictionary.ContainsKey(number);
    }
}